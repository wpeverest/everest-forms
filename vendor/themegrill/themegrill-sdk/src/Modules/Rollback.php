<?php
/**
 * The rollback class for ThemeGrill SDK.
 *
...
/**
 * Rollback for ThemeGrill SDK.
 */
class Rollback extends AbstractModule {
	...
	/**
	 * Set the rollback hook. Strangely, this does not work if placed in the ThemeGrill_SDK_Rollback class, so it is being called from there instead.
	 */
