		...
		uglify: {
			...
			vendor: {
				files: {
					...
					'<%= dirs.js %>/jquery-confirm/jquery-confirm.min.js': [
						'<%= dirs.js %>/jquery-confirm/jquery-confirm.js',
					],
					'<%= dirs.js %>/jquery-validate/jquery.validate.min.js': [
						'<%= dirs.js %>/jquery-validate/jquery.validate.js',
					],
					'<%= dirs.js %>/flatpickr/flatpickr.min.js': [
						'<%= dirs.js %>/flatpickr/flatpickr.js',
					],
					'<%= dirs.js %>/mailcheck/mailcheck.min.js': [
						'<%= dirs.js %>/mailcheck/mailcheck.js',
					],
