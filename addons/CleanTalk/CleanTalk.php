...
class CleanTalk {
	...
	public function evf_get_popup_output(){
		...
		$output .= '</svg>';
		$output .= '<strong>Note:</strong>' . __( "This will update the CleanTalk Access Key globally. You can check here on ", 'everest-forms' );
		$output .= '<a href="#">' . __( "Settings &gt; Integration &gt; CleanTalk", 'everest-forms' ) .'</a>.';
		$output .= '</div>';
