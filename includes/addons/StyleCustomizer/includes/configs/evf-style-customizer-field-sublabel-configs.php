<?php
/**
 * EverestForms Field Sub Label Config Functions
 *
 ...
 */
function evf_style_customizer_field_sublabels_sections( $sections ) {
	return array_merge(
		$sections,
		array(
			'everest_forms_field_sublabels' => array(
				'title'              => esc_html__( 'Field Sublabels', 'everest-forms' ),
				'description'        => esc_html__( 'This is field sublabels description.', 'everest-forms' ),
				'priority'           => 10,
...
add_filter( 'everest_forms_style_customizer_sections', 'evf_style_customizer_field_sublabels_sections' );
 ...
 */
function evf_style_customizer_field_sublabels_controls( $controls ) {
	$controls['field_sublabel'] = array(
		'font_size'      => array(
			'setting' => array(
				'default'           => '12',
			...
			'control' => array(
				...
				'section'     => 'everest_forms_field_sublabels',
...
add_filter( 'everest_forms_style_customizer_controls', 'evf_style_customizer_field_sublabels_controls' );
