...
class EVF_Field_Date_Time extends EVF_Form_Fields {
	...
	public function datetime_options( $field ) {
		...
		if ( 'g:i A' === $time_format ) {
			...
			$hours_array = array(
				'-' => esc_html__( 'Hours', 'everest-forms' ),
				0   => esc_html__( '0 AM', 'everest-forms' ),
				1   => esc_html__( '1 AM', 'everest-forms' ),
				2   => esc_html__( '2 AM', 'everest-forms' ),
				3   => esc_html__( '3 AM', 'everest-forms' ),
				4   => esc_html__( '4 AM', 'everest-forms' ),
				5   => esc_html__( '5 AM', 'everest-forms' ),
				6   => esc_html__( '6 AM', 'everest-forms' ),
				7   => esc_html__( '7 AM', 'everest-forms' ),
				8   => esc_html__( '8 AM', 'everest-forms' ),
				9   => esc_html__( '9 AM', 'everest-forms' ),
				10  => esc_html__( '10 AM', 'everest-forms' ),
				11  => esc_html__( '11 AM', 'everest-forms' ),
				12  => esc_html__( '12 PM', 'everest-forms' ),
				13  => esc_html__( '13 PM', 'everest-forms' ),
				14  => esc_html__( '14 PM', 'everest-forms' ),
				15  => esc_html__( '15 PM', 'everest-forms' ),
				16  => esc_html__( '16 PM', 'everest-forms' ),
				17  => esc_html__( '17 PM', 'everest-forms' ),
				18  => esc_html__( '18 PM', 'everest-forms' ),
				19  => esc_html__( '19 PM', 'everest-forms' ),
				20  => esc_html__( '20 PM', 'everest-forms' ),
				21  => esc_html__( '21 PM', 'everest-forms' ),
				22  => esc_html__( '22 PM', 'everest-forms' ),
				23  => esc_html__( '23 PM', 'everest-forms' ),
			);
		}
		$minutes_array = array(
			'-' => 'Minutes',
		...
		$min_time_select .= $this->field_element(
			...
			array(
				'slug'    => 'min_time_hour',
				'value'   => isset( $field['min_time_hour'] ) ? $field['min_time_hour'] : '',
				'class'   => 'min_time_hour',
				'options' => $hours_array,
			),
			false
		...
		$min_time_select .= $this->field_element(
			...
			array(
				...
				'value'   => isset( $field['min_time_minute'] ) ? $field['min_time_minute'] : '',
		...
		$max_time_select .= $this->field_element(
			...
			array(
				'slug'    => 'max_time_hour',
				'value'   => isset( $field['max_time_hour'] ) ? $field['max_time_hour'] : '',
				'class'   => 'max_time_hour',
				'options' => $hours_array,
			),
			false
		...
		$max_time_select .= $this->field_element(
			...
			array(
				...
				'value'   => isset( $field['max_time_minute'] ) ? $field['max_time_minute'] : '',
