...
abstract class EVF_Form_Fields {
	...
	public function field_new() {
		...
		if ( 'repeater-fields' !== $field_type ) {
			$preview .= sprintf( '<a href="#" class="everest-forms-field-drag" title="%s"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 17 16" fill="none">
			...
			$preview .= sprintf( '<a href="#" class="everest-forms-field-duplicate" title="%s"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none">
			...
			$preview .= sprintf( '<a href="#" class="everest-forms-field-setting" title="%s"><svg class="dashicons-admin-generic" xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 17 16" fill="none">
			...
			$preview .= sprintf( '<a href="#" class="everest-forms-field-delete" title="%s"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 21 20" fill="none">
