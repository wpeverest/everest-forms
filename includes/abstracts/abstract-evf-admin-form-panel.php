...
abstract class EVF_Admin_Form_Panel {
	...
	public function panel_sidebar_section( $name, $slug, $icon = '' ) {
		...
		echo '<a href="#" class="evf-setting-panel-tab evf-setting-panel everest-forms-panel-sidebar-section everest-forms-panel-sidebar-section-' . esc_attr( $slug ) . $class . '" data-section="' . esc_attr( $slug ) . '">';
