				...
				'inputs'      => array(
					'primary' => array(
						'attr'     => array(
							...
							'value'       => apply_filters( 'everest_forms_process_save_and_continue_value', isset( $field['default_value'] ) ? apply_filters( 'everest_forms_process_smart_tags', $field['default_value'], $form_data ) : $defaults, $field_id, $form_data ),
