...
class EVF_Admin_Addons {
	...
	public static function get_sections() {
		...
		if ( false === $addon_sections ) {
			$raw_sections = wp_remote_get( evf()->plugin_url( '/assets/extensions-json/addon-sections.json' ) );
	...
	public static function get_extension_data() {
		...
		if ( false === $extension_data ) {
			$raw_extensions = wp_remote_get( evf()->plugin_url( 'assets/extensions-json/sections/all_extensions.json' ) );
