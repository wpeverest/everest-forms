...
class EVF_Admin_Forms_Table_List extends WP_List_Table {
	...
	public function prepare_items() {
		...
		$args['order']   = isset( $_REQUEST['order'] ) && 'ASC' === strtoupper( evf_clean( sanitize_text_field( wp_unslash( $_REQUEST['order'] ) ) ) ) ? 'ASC' : 'DESC'; // phpcs:ignore WordPress.Security.NonceVerification
