...
<div class="everest-forms-export-form">
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin.php?page=evf-tools&tab=export' ) ); ?>">
		...
		if ( ! empty( $forms ) ) {
			echo '<select id="everest-forms-form-export" class="evf-enhanced-select" style="min-width: 350px;" name="form_ids[]" data-placeholder="' . esc_attr__( 'Select form', 'everest-forms' ) . '" multiple><option value="">' . esc_html__( 'Select a form', 'everest-forms' ) . '</option>';
