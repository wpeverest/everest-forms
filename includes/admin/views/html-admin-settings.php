	...
	<div class="everest-forms-settings">
		...
		<div class="everest-forms-settings-premium-sidebar <?php echo esc_attr( $is_premium_sidebar_class ); ?>" id="everest-forms-settings-premium-sidebar">
			<?php
				...
				<a href="https://everestforms.net/upgrade/?utm_campaign=lite-version&utm_source=premium-cta-&utm_medium=upgrade-cta-button"  target="_blank" class="everest-forms-premium-sidebar-button">Get the Everest Forms Pro</a>
