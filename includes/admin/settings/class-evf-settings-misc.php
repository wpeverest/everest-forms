	...
	public function get_settings() {
		...
		$settings = apply_filters(
			...
			array(
				...
				array(
					'title'    => esc_html__( 'Enable Zapier Api Key', 'everest-forms' ),
					'desc'     => __( 'This is zapier Api key', 'everest-forms' ),
					'id'       => 'everest_forms_enable_zapier_api',
					'type'     => 'toggle',
					'default'  => 'no',
					'desc_tip' => true,
				),
				array(
					'title'    => esc_html__( 'Zapier Api Key', 'everest-forms' ),
					'desc'     => __( 'List of api key.These are used to authenticate the request.', 'everest-forms' ),
					'id'       => 'everest_forms_zapier_app_api_keys',
					'type'     => 'restapi_key',
					'default'  => '',
					'desc_tip' => true,
					'css'      => 'width=500px !important;',
