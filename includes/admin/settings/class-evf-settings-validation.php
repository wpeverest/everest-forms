	...
	public function get_settings() {
		$settings = apply_filters(
			...
			array(
				...
				array(
					'title'    => esc_html__( 'Confirm Value', 'everest-forms-pro' ),
					'desc'     => esc_html__( 'Enter the message for confirm field value.', 'everest-forms-pro' ),
					'id'       => 'everest_forms_confirm_validation',
					'type'     => 'text',
					'desc_tip' => true,
					'css'      => 'min-width: 350px;',
					'default'  => esc_html__( 'Field values do not match.', 'everest-forms-pro' ),
				),
				array(
