				...
				switch ( $value['type'] ) {
					...
					case 'image':
						...
						<tr valign="top">
							...
							<button class="evf-image-uploader evf-button <?php echo empty( $option_value ) ? '' : 'everest-forms-hidden'; ?>" style="padding:5px 20px;"><?php echo esc_html__( 'Upload Logo', 'everest-forms' ); ?></button>
							<input
								name="<?php echo esc_attr( $value['id'] ); ?>"
								id="<?php echo esc_attr( $value['id'] ); ?>"
								value="<?php echo esc_attr( $option_value ); ?>"
