			...
			<?php else : ?>
				<div class="everest-forms-BlankState">
					...
					<?php else : ?>
						...
						<a class="everest-forms-BlankState-cta button" href="<?php echo esc_url( admin_url( 'admin.php?page=evf-setup&create-form=1' ) ); ?>"><?php esc_html_e( 'Create your first form!', 'everest-forms' ); ?></a>
					<?php endif; ?>
