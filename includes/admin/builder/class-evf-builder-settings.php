								...
								<div class="evf-email-side-section">
									...
									<a class="<?php echo esc_attr($preview_class); ?>" target="__blank" data-connection-id="<?php echo esc_attr($connection_id); ?>" href="<?php echo esc_url($preview_url); ?>">
										<span class="<?php echo esc_attr($preview_class); ?>">
											...
											<path d="M12 5c2.116 0 4.183.648 5.941 1.861a10.94 10.94 0 0 1 3.776 4.58l.158.375.011.032a1.93 1.93 0 0 1-.011 1.335 10.95 10.95 0 0 1-3.934 4.956A10.45 10.45 0 0 1 12.001 20c-2.116 0-4.184-.648-5.942-1.861a10.95 10.95 0 0 1-3.934-4.955l-.011-.032a1.93 1.93 0 0 1 0-1.304l.011-.032A10.95 10.95 0 0 1 6.06 6.861 10.45 10.45 0 0 1 12 5m0 1.875A8.7 8.7 0 0 0 7.07 8.42a9.1 9.1 0 0 0-3.251 4.08 9.1 9.1 0 0 0 3.25 4.08A8.7 8.7 0 0 0 12 18.125a8.67 8.67 0 0 0 4.93-1.545c1.45-1 2.58-2.42 3.25-4.08a9.1 9.1 0 0 0-3.25-4.08A8.67 8.67 0 0 0 12 6.875"/>
											<path d="M13.818 12.5c0-1.036-.814-1.875-1.818-1.875s-1.818.84-1.818 1.875.814 1.875 1.818 1.875 1.818-.84 1.818-1.875m1.818 0c0 2.071-1.628 3.75-3.636 3.75s-3.636-1.679-3.636-3.75S9.992 8.75 12 8.75s3.636 1.679 3.636 3.75"/>
											</svg>
