			...
			if ( isset( $_GET['create-form'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification
				...
				wp_localize_script(
					...
					array(
						...
						'upgrade_message'       => esc_html__( 'We\'re sorry. This template requires premium addons.<br>Please upgrade to the Premium plan to unlock all these awesome Templates.', 'everest-forms' ),
