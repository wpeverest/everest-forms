	...
	public function admin_scripts() {
		...
		wp_localize_script(
			...
			array(
				...
				'upgrade_url'                     => apply_filters( 'everest_forms_upgrade_url', 'https://everestforms.net/upgrade/?utm_source=builder-fields&utm_medium=premium-field-popup&utm_campaign=' . evf()->utm_campaign ),
				'upgrade_integration_url'         => apply_filters( 'everest_forms_upgrade_integration_url', 'https://everestforms.net/upgrade/?utm_source=builder-settings&utm_medium=premium-form-settings-popup&utm_campaign=' . evf()->utm_campaign ),
			...
			if ( isset( $_GET['create-form'] ) || isset( $_GET['form_id'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification
				...
				wp_localize_script(
					...
					array(
						...
						'upgrade_url'                  => apply_filters( 'everest_forms_upgrade_url', 'https://everestforms.net/upgrade/?utm_source=form-template&utm_medium=button&utm_campaign=' . evf()->utm_campaign ),
