...
class EVF_Admin_Assets {
	...
	public function admin_styles() {
		...
		wp_register_style( 'everest-forms-admin-entries', EVF()->plugin_url() . '/assets/css/admin-entries.css', array(), EVF_VERSION );
		...
		wp_style_add_data( 'everest-forms-admin-entries', 'rtl', 'replace' );
		...
		if ( in_array( $screen_id, array( 'toplevel_page_everest-forms', 'everest-forms_page_evf-entries' ), true ) ) {
			wp_enqueue_style( 'everest-forms-admin-entries' );
		}
	}
