...
if ( ! class_exists( 'EVF_Admin_Assets', false ) ) :
	...
	class EVF_Admin_Assets {
		...
		public function admin_styles() {
			...
			wp_register_style( 'everest_forms_admin_builder_styles', EVF()->plugin_url() . '/assets/css/everest-builder.css', array(), EVF_VERSION );
			...
			if ( in_array( $screen_id, array( 'everest-forms_page_edit-evf-form' ) ) ) {
				wp_enqueue_style( 'everest_forms_admin_builder_styles' );
			}
