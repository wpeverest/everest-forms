	...
	public function admin_scripts() {
		...
		wp_localize_script(
			...
			array(
				...
				'evf_legacy_payment_blocks_gateway_title'    => esc_html__( 'Payment Method field unavailable', 'everest-forms' ),
				'evf_legacy_payment_blocks_gateway_message' => esc_html__( 'Remove %s before adding the Payment Method field.', 'everest-forms' ),
				'evf_legacy_payment_label_credit_card'      => esc_html__( 'Credit Card', 'everest-forms' ),
			...
			if ( isset( $_GET['create-form'] ) || isset( $_GET['form_id'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification
				...
				wp_localize_script(
					...
					array(
						...
						'upgrade_url'                  => apply_filters( 'everest_forms_upgrade_url', 'https://everestforms.net/upgrade/?utm_medium=evf-template-page&utm_source=evf-free&utm_campaign=template-premium-popup' ),
	...
	public function enqueue_dashboard_scripts() {
		...
		wp_localize_script(
			...
			array(
				...
				'allStepsCompleted' => (
					EVF_Admin_Dashboard::is_spam_protection_completed()
