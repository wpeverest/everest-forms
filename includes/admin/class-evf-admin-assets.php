	...
	public function admin_scripts() {
		...
		wp_localize_script(
			...
			array(
				...
				'enable_verifone_title'          => esc_html__( 'Please enable (2Checkout)Verifone', 'everest-forms' ),
				'enable_verifone_message'        => esc_html__( 'Enable (2Checkout)Verifone Payment gateway in payments section to use this field.', 'everest-forms' ),
